...
const FAQS = [
  ...
  { q: 'Is GoldBook free?', a: 'GoldBook offers a generous, forever-free plan that includes unlimited manual journaling, a complete advanced interactive charting terminal, and full performance analytics. For advanced automated MT5 syncing, real-time AI behavioral coaching, and visual replay backtesting, we offer paid and pro tier subscriptions.' },
